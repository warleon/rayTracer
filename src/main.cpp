...
int main() {
  ...
  Ray cameraRay(glm::vec3(-0.02f, 0.11f, -0.5f),
                glm::vec3(0.0f, 0.0f, 1.0f));  // Camera facing +Z
  ...
  DirectionalLight dlight(glm::vec3(1.0f, 0.0f, 0.0f),
                          glm::vec3(-1.0f, -1.0f, 1.0f));
  PointLight plight(glm::vec3(0.0f, 0.0f, 1.0f),
                    cameraRay.getOrigin() + glm::vec3(0.0f, 0.4f, 0.0f));
